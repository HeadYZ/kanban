...
const Header = ({ showMobileNavHandler, smallScreen }) => {
	return (
		<header className='flex h-6.4 px-1.6 bg-white dark:bg-dark-grey tablet:col-start-1 tablet:col-end-3 tablet:row-start-1 tablet:h-8 tablet:px-2.4  lg:h-9.6 lg:px-3.4'>
			...
			<div className='flex items-center justify-between w-full tablet:pl-2.4'>
				...
				<div className='flex items-center gap-x-1.6'>
					<Button className='flex items-center justify-center w-4.8 h-3.2 bg-purple rounded-2.4 opacity-25 tablet:text-hm tablet:w-16.4 tablet:h-4.8 tablet:text-white'>
